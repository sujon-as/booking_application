...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Speciality</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All Speciality</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('specialities.create')}}" class="btn btn-primary add-new mb-2">Add New Speciality</a>
  	...
  	$(document).ready(function(){
        ...
        $(document).on('click', '#status-update', function(){
            ...
            $.ajax({
                ...
                url: "{{ url('/speciality-status-update') }}",
