...
class SpecialityController extends Controller
{
            ...
            if($request->ajax()){
                ...
                return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn .= ' <a href="'.route('specialities.show',$row->id).'" class="btn btn-primary btn-sm action-button edit-data" data-id="'.$row->id.'"><i class="fa fa-edit"></i></a>';
    ...
    public function store(SpecialityRequest $request)
    {
        ...
        try
        {
            ...
            return redirect()->route('specialities.index')->with($notification);
    ...
    public function specialityStatusUpdate(SpecialityRequest $request)
    {
        DB::beginTransaction();
        try
        {
            $data = Speciality::findorfail($request->id);
            $data->status = $request->status;
            $data->update();
